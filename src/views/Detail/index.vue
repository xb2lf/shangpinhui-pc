          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                />
                <a href="javascript:" class="plus" @click="handleIncrease">+</a>
                <a href="javascript:" class="mins" @click="handleDecrease">-</a>
              </div>
              <div class="add">
                <a href="javascript:" @click="handleAddShopCart">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    handleChangeActive(spuSaleAttrValue, spuSaleAttrValueList) {
